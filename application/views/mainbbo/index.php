<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <div class="table-responsive small">
            <table class="table table-striped table-sm" id="mainbbotable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>mainbbo/tambah" method="POST" enctype="multipart/form-data">
