<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?= base_url('mainkendaraan') ?>">Utama</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('mainkendaraan/detail') ?>">Detail</a>
            </li>
        </ul>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>mainkendaraan/tambah" method="POST" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        $("#viewModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>mainkendaraan/getview",
                data: {
                    id: id
                }
        ...
        $("#editModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>mainkendaraan/getedit",
                data: {
                    id: id
                }
            }).done(function(response) {
