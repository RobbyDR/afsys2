<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <div class="table-responsive small">
            <table class="table table-striped table-sm" id="yramsdmtable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">nip</th>
                ...
                <tbody>
                    <?php foreach ($get as $row): ?>
                        ...
                        <tr class="<?= $row['status'] == "0" ? 'fw-lighter' : ''; ?>">
                            <td><?= $row['id'] ?></td>
                            <td><?= $row['nip'] ?></td>
                            <td><?= $row['nama'] ?></td>
                            <td><?= $row['nik'] ?></td>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>yramsdm/tambah" method="POST" enctype="multipart/form-data">
