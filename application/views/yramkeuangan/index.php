<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <div class="table-responsive small">
            <table class="table table-striped table-sm" id="yramkeuangantable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>yramkeuangan/tambah" method="POST" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        $("#viewModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>yramkeuangan/getview",
                data: {
                    id: id
                }
        ...
        $("#editModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>yramkeuangan/getedit",
                data: {
                    id: id
                }
            }).done(function(response) {
