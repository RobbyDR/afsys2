<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <div class="table-responsive small">
            <table class="table table-striped table-sm" id="mainlisttable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody>
                    <?php foreach ($get as $row): ?>
                        ...
                        <tr class="<?= $row['status'] == "2" ? 'text-muted text-decoration-line-through' : ''; ?>">
                            ...
                            <td><?= $row['deskripsi'] ?></td>
                            <td><?= $row['tgl1'] ?></td>
                            <td><?= ($row['tgl2'] == '0000-00-00') ? "" : $row['tgl2'] ?></td>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>mainlist/tambah" method="POST" enctype="multipart/form-data">
