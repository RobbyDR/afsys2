<div class="container-fluid scrollarea">
    <div class="row ">
        ...
        <div class="table-responsive small">
            <table class="table table-striped table-sm" id="tkqkegiatantable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="<?= base_url('tkqkegiatan/album/' . $row['id']) ?>">Album</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>tkqkegiatan/tambah" method="POST" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        ...
        $("#editModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>tkqkegiatan/getedit",
                data: {
                    id: id
                }
            }).done(function(response) {
