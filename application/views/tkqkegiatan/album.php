<div class="container-fluid scrollarea">
    <div class="row ">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <a href="<?= base_url('tkqkegiatan') ?>" class="btn btn-outline-secondary btn-sm mx-1">back</a>
            <div class="col">
                    ...
                    <?php foreach ($get as $row): ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <a href="<?= base_url('upload/tkqkegiatan/' . $row['nama']) ?>" target="_blank">
                                    <?php
                                    ...
                                    if (in_array(strtolower($file_ext), $image_ext)) {
                                        ...
                                        echo '<img class="bd-placeholder-img card-img-top" width="100%" height="225" src="' . base_url('upload/tkqkegiatan/' . $row['nama']) . '" alt="" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">';
                                    } else {
...
<div class="modal modal-xl fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>tkqkegiatan/tambahalbum" method="POST" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: "<?= base_url() ?>tkqkegiatan/getview",
        //         data: {
        //             id: id
        //         }
        ...
        $("#editalbumModal").on('shown.bs.modal', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>tkqkegiatan/geteditalbum",
                data: {
                    id: id,
                    utamaid: utamaid
                }
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                ...
                return new Promise(function(resolve, reject) {
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url() ?>tkqkegiatan/delalbum",
                        data: {
                            id: id,
                            nama: nama,
                            path: path
