...
<body>
    ...
    <?php if ($this->session->flashdata('msg')): ?>
        <div class="alert alert-<?= $this->session->flashdata('msg_type'); ?> alert-dismissible fade show position-fixed bottom-0 end-0 mb-5 me-5" role="alert">
                ...
                <?php foreach ($getmenu as $row) : ?>
                    <li class="mb-1">
                        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
                            data-bs-toggle="collapse" data-bs-target="#home-collapse<?= $row['id'] ?>" aria-expanded="true">
                            <!-- <svg class="bi pe-none me-2" width="16" height="16">
                                <use xlink:href="#home" />
                            </svg> -->
                            <i data-feather="wind" width="24" height="16"></i>
                            <?= $row['nama'] ?>
                        </button>
                        <div class="collapse show" id="home-collapse<?= $row['id'] ?>">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <?php foreach ($getsubmenu as $rows): ?>
                                    <?php if ($rows['menuid'] == $row['id']): ?>
                                        <li><a href="<?= base_url($rows['link']) ?>" class="link-body-emphasis d-inline-flex text-decoration-none rounded"><?= $rows['nama'] ?></a></li>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </ul>
                        </div>
